...
print('{0:35s}  {1:>15s} {2:>15s} {3:>15s} {4:>15s}'.format('Nazva','perItemSell','OneRunSell','zatraro','profito'))
print('-------------------')
for url in urls:
    ...
    print('{0:35s}  {1:>15s} {2:>15s} {3:>15s} {4:>15s}'.format(nazva,oneitem_sell,pluso,zatraro,profito))
